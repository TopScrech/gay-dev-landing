...
<a class="wishlist" class:compact href={LINKS.wishlist} aria-label="Wishlist on Steam">
...
<style>
  ...
  .wishlist:hover {
    background: var(--wisp-hi);
    box-shadow: 0 0 32px oklch(0.88 0.17 128 / 0.35);
